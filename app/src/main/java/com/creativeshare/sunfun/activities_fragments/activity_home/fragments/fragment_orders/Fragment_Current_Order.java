...
public class Fragment_Current_Order extends Fragment {
    ...
    private void initView() {
        ...
        getOrders();
        myOrderViewModel.dataCurrentOrder.observe(this, orderModelList -> {
            ...
            Fragment_Current_Order.this.orderModelList.clear();
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0) {
                    ...
                    if (totalItems > 10 && (totalItems - lastVisiblePos) == 3 && !isLoading) {
                        ...
                        myOrderViewModel.loadMoreCurrentOrder(userModel.getUser().getId());
                    }
        ...
        myOrderViewModel.errorCurrentOrder.observe(this, aBoolean -> {
            binding.swipeRefresh.setRefreshing(false);
            binding.progBar.setVisibility(View.GONE);

        });

        myOrderViewModel.errorLoadMoreCurrentOrder.observe(this, aBoolean -> {
            isLoading = false;
        ...
        binding.swipeRefresh.setOnRefreshListener(() -> myOrderViewModel.getMyCurrentOrder(userModel.getUser().getId()));

    }

    public void getOrders() {
        myOrderViewModel.getMyCurrentOrder(userModel.getUser().getId());
